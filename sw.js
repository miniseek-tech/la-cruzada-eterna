const CACHE_NAME='cruzada-eterna-v6';
const CORE=['./','./index.html','./styles.css','./menu-redesign.css','./menu-redesign.js','./ambient-music.js','./bestiario-art.js','./assets/nigromante-inline.js','./manifest.webmanifest','./assets/icon-cruzada.svg','./assets/nigromante-bestiario.webp'];
...
function injectMusic(response){
  ...
  return response.text().then(html=>{
    ...
    if(!html.includes('bestiario-art.js'))html=html.replace(/<\/body>/i,'<script src="./bestiario-art.js?v=3"></script></body>');
