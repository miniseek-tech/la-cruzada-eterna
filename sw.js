const CACHE_NAME='cruzada-eterna-v29';
...
function injectMusic(response){
  ...
  return response.text().then(html=>{
    ...
    if(/bestiario-art\.js(?:\?v=\d+)?/i.test(html))html=html.replace(/bestiario-art\.js(?:\?v=\d+)?/ig,'bestiario-art.js?v=19');
    else html=html.replace(/<\/body>/i,'<script src="./bestiario-art.js?v=19"></script></body>');
