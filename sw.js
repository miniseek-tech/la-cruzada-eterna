const CACHE_NAME='cruzada-eterna-v8';
const CORE=['./','./index.html','./styles.css','./menu-redesign.css','./menu-redesign.js','./ambient-music.js','./bestiario-art.js','./assets/nigromante-inline.js','./manifest.webmanifest','./assets/icon-cruzada.svg','./assets/nigromante-bestiario.webp','./assets/esqueleto-bestiario.jpg','./assets/esqueleto-arquero-bestiario.webp'];
...
function injectMusic(response){
  ...
  return response.text().then(html=>{
    ...
    if(!html.includes('bestiario-art.js'))html=html.replace(/<\/body>/i,'<script src="./bestiario-art.js?v=5"></script></body>');
