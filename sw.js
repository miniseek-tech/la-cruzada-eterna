const CACHE_NAME='cruzada-eterna-v21';
...
function injectMusic(response){
  ...
  return response.text().then(html=>{
    ...
    if(/bestiario-art\.js(?:\?v=\d+)?/i.test(html)){
      html=html.replace(/bestiario-art\.js(?:\?v=\d+)?/ig,'bestiario-art.js?v=14');
    }else{
      html=html.replace(/<\/body>/i,'<script src="./bestiario-art.js?v=14"></script></body>');
    }
